...
function education(edu){
  ...
  eduTable.border="1";
  var tr1="<tr><td>Degree</td><td>Institute</td><td>data</td><td>Gpa</td></tr>";
  eduTable.innerHTML=tr1;
  var tr2="";
  for (var i = 0; i < edu.length; i++) {
    tr2+="<tr><td>"+edu[i].degree+"</td><td>"+edu[i].institute+"</td><td>"+edu[i].data+"</td><td>"+edu[i].gpa+"</td></tr>";
  }
...
function skills(skil){
  ...
  skilHeading.textContent="Technical Skills:";
  child2.appendChild(skilHeading);
  var skillsHr=document.createElement("hr");
  child2.appendChild(skillsHr);
